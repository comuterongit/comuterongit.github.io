...
**⚠️ Astronaut has limited compability with version structures other than the [xx version structure](#5.2%20-%20xx%20Version%20Structure).**
### 2.1.6 - ChangelogURL
Similar to [VerNumURL](#2.1.4%20-%20VerNumURL), ChangelogURL needs a URL which links to a .txt file containing your changelog. If no changelog avaliable, just create a file telling the user that no changelog is available.
> **Options/Values**
> Text Input (URL Example: https://example.com/example.txt)
### 2.1.7 - UpdateURL
